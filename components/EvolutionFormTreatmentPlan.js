...
const EvolutionFormTreatmentPlan = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.descriptionText}>Plano de Tratamento:</Text>

      <Text style={styles.label}>Descrição dos Medicamentos *</Text>
        <TextInput
      ...
      <Text style={styles.label}>Descrição das Dosagens *</Text>
        <TextInput
          style={[styles.inputField, { height: 100 }]}
          placeholderTextColor="#a9a9a9"
          multiline={true}
      ...
      <Text style={styles.label}>Descrição das Frequências *</Text>
        <TextInput
          style={[styles.inputField, { height: 100 }]}
          placeholderTextColor="#a9a9a9"
          multiline={true}
...
export default EvolutionFormTreatmentPlan;
